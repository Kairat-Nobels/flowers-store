    ...
    return (
        <div className="home-contact page-container p-5 d-flex flex-column align-items-center justify-content-center">
            ...
            <div className="mt-4 text-center">
                <a href="https://wa.me/996705922401" target="_blank" rel="noopener noreferrer" className="btn btn-success d-flex align-items-center justify-content-center gap-2">
                    <FaWhatsapp /> WhatsApp
                </a>
            </div>
        </div>
